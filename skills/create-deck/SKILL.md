...
Story structure rules live in `skills/create-deck/storytelling.md`. Follow that guide for Pyramid Principle, SCQA flow, action titles, WWWH framing, and the five pre-flight questions.
...
- Before Phase 1, read `skills/create-deck/storytelling.md`
- Before locking or overriding layouts in Phase 1 or Phase 2, read `skills/create-deck/layout-selection.md`
- Before adding a chart in Phase 2, read `skills/create-deck/chart-guide.md`
- Before Phase 3, read `skills/create-deck/common-mistakes.md`
...
Read `skills/create-deck/storytelling.md` and `skills/create-deck/layout-selection.md`, then draft the narrative in this order:
...
Apply the Isomorphism Principle from `skills/create-deck/layout-selection.md`:
...
- Follow the layout variety rule from `skills/create-deck/layout-selection.md`.
...
5. If a slide needs a chart, read `skills/create-deck/chart-guide.md` first, then use `uv run agent-slides chart add ...`.
...
Before QA, read `skills/create-deck/common-mistakes.md`.
...
- If the brief is under-specified, ask or infer the five pre-flight inputs from `skills/create-deck/storytelling.md`: audience, objective, recommendation, scope, and target slide count.
- Organize the deck as answer -> 2-4 supporting arguments -> evidence.
- Give each content slide one message and an action title that states the takeaway.
